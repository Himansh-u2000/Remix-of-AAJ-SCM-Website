...
// Kolkata client logos (8 reworked)
import daakitLogo from "@/assets/clients-kolkata/Daakit.png";
import elsevierLogo from "@/assets/clients-kolkata/Elsevier.png";
import harperLogo from "@/assets/clients-kolkata/HarperCollins.png";
import relxLogo from "@/assets/clients-kolkata/Relx.png";
import synergyLogo from "@/assets/clients-kolkata/SynergyIntact.png";
import visscoLogo from "@/assets/clients-kolkata/Vissco.png";
import zorayaLogo from "@/assets/clients-kolkata/Zoraya.png";
import fridoLogo from "@/assets/clients-kolkata/Frido.png";
// 4 recycled logos from other city pages
...
const trustBar = [
  ...
  { label: "East & North-East Coverage" },
];

const whyKolkata = [
  { title: "Eastern India Access", desc: "Serve East and North-East India from one strategic location.", icon: Compass },
...
const corridors = [
  { code: "NH-16", route: "Kolkata – Kharagpur – Bhubaneswar", desc: "A major freight corridor connecting West Bengal with Odisha and South-East India, supporting high-frequency regional deliveries and industrial freight movement." },
  { code: "NH-19", route: "Kolkata – Dhanbad – Varanasi", desc: "Part of the Golden Quadrilateral network connecting Eastern India with major industrial and consumption markets across Jharkhand and Uttar Pradesh." },
  { code: "NH-12", route: "Kolkata – Berhampore – Siliguri", desc: "Critical northbound corridor enabling freight movement towards North Bengal and North-East India with faster regional access." },
  { code: "Kona Expy", route: "Kolkata – Howrah – Dankuni", desc: "One of Kolkata's key freight movement routes connecting warehouses, transport hubs, highways and industrial corridors while reducing inner-city congestion." },
];

const industrialZones = ["Dankuni", "Howrah", "Uluberia", "Dhulagarh", "Baruipur", "Kona"];
const logisticsCorridors = ["Haldia", "Kharagpur", "Siliguri Route", "Bagnan", "Hooghly", "Durgapur Corridor"];

const facilityStats = [
  { value: "50,000+", unit: "Sq. Ft.", label: "Strategically located warehouse space", icon: Warehouse },
...
const builtFor = [
  { tag: "Quick Commerce", title: "Hyperlocal & same-day delivery brands", desc: "Operations that require rapid dispatch and same-day fulfilment need a warehouse strategically located within Kolkata's core delivery network.", icon: Zap },
  { tag: "Marketplaces", title: "Sellers with strong Eastern India order flow", desc: "Amazon, Flipkart, Meesho and Myntra orders concentrated across West Bengal, Odisha, Bihar and North-East regions.", icon: Box },
  { tag: "Cross-Region", title: "Brands shipping from North or West to East India", desc: "Facing longer delivery timelines, higher freight costs and operational delays for Eastern India fulfilment.", icon: TrendingUp },
  { tag: "High RTO", title: "Brands seeing higher RTO across Eastern regions", desc: "Delivery failures caused by longer transit routes, delayed fulfilment and inconsistent inventory placement.", icon: RefreshCw },
  { tag: "Scaling", title: "Rising regional demand near Kolkata", desc: "Increasing order volumes that require faster inventory positioning and scalable warehousing support.", icon: Rocket },
];
...
const operations = [
  { title: "Planned Dispatch Cycles", desc: "In a high-volume market like Kolkata, dispatch follows fixed cycles to meet same-day, next-day and quick commerce SLAs without delays or congestion." },
  { title: "Movement-Level Inventory Tracking", desc: "With faster inventory rotation across Eastern India, tracking movement at every step ensures stock accuracy during high-frequency order processing." },
  { title: "Batch & SKU Accuracy at Every Step", desc: "Multi-SKU and distributor-driven orders in Eastern India demand strict accuracy to avoid returns and fulfilment errors." },
  { title: "Multi-Distributor Order Structuring", desc: "Serving multiple regions from Kolkata requires structured order handling for different distributors, cities and shipment types." },
  { title: "Transport-Aligned Dispatch Planning", desc: "Kolkata's dense transport network allows faster movement — but only when dispatch is aligned with route availability and carrier schedules." },
];
...
const migrationSteps = [
  ...
  { title: "Process Alignment", desc: "Workflows are aligned to match how orders, inventory and dispatch will run from the Kolkata warehouse." },
...
const faqs = [
  { q: "How does Kolkata's port connectivity benefit warehouse and distribution operations?", a: "Kolkata's access to port-linked freight corridors helps improve inbound inventory movement, regional distribution efficiency and supply chain connectivity for Eastern India operations." },
  { q: "Can your Kolkata warehouse support phased inventory deployment across Eastern India markets?", a: "Yes. Inventory can be strategically distributed in phases based on regional demand patterns and market expansion requirements." },
  { q: "How does AAJ manage dispatch planning for long-distance shipments to North-East India?", a: "Dispatch operations are coordinated through route planning, carrier alignment and shipment prioritization to improve transit efficiency for North-East deliveries." },
  { q: "Can brands manage multiple product categories from the same Kolkata warehouse operation?", a: "Yes. Different inventory categories can be stored, processed and dispatched through separate workflows while maintaining operational visibility and fulfilment accuracy." },
  { q: "How do you optimize warehouse operations for brands handling both fast-moving and seasonal inventory?", a: "Inventory placement and fulfilment workflows are structured around stock movement patterns to improve warehouse efficiency and dispatch performance." },
  { q: "Can your Kolkata warehouse support inventory redistribution during regional demand fluctuations?", a: "Yes. Inventory can be repositioned and transferred based on changing order trends and regional consumption requirements across Eastern India." },
  { q: "How does AAJ reduce operational delays during high inbound freight movement at the Kolkata warehouse?", a: "Inbound operations are managed through scheduled unloading, organized stock verification and structured inward workflows to maintain operational continuity." },
  { q: "Can brands use your Kolkata warehouse to improve delivery coverage in underserved Eastern India markets?", a: "Yes. Strategic inventory placement in Kolkata helps brands improve fulfilment reach and delivery timelines across emerging Eastern and North-East Indian markets." },
];

const Kolkata = () => {
  return (
    <>
      <Seo {...pageSeo["/warehouses/kolkata"]} />
          ...
          <div className="mt-6 grid gap-12 lg:grid-cols-12 lg:gap-10">
            <div className="lg:col-span-7">
              ...
              <h1 className="mt-5 font-display text-4xl font-semibold leading-[1.05] md:text-5xl lg:text-[56px]">
                ...
                <span className="text-primary">Structured Warehouse Service</span>{" "}
                in Kolkata
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                Gain complete control over your warehouse operations in Kolkata with accurate inventory management, faster dispatch cycles and seamless same-day fulfilment as your order volumes continue to grow.
              </p>
              <p className="mt-4 max-w-2xl text-sm text-muted-foreground">
                Leading warehouse company in Kolkata for high-volume inventory, complex fulfilment operations and time-critical dispatch management.
              </p>
            ...
            {/* Hero snapshot card — Kolkata river/port motif */}
            <div className="lg:col-span-5">
              <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-7 shadow-elevated md:p-8">
                ...
                <div className="relative flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                  <Sparkles className="h-3.5 w-3.5" /> Kolkata Hub Snapshot
                </div>

                <div className="relative mt-6">
                  <div className="flex items-end gap-2">
                    <div className="font-display text-6xl font-semibold leading-none text-ink">50K+</div>
                  ...
                  <div className="mt-7 rounded-2xl border border-border bg-secondary/40 p-4">
                    <div className="mb-3 flex items-center justify-between text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
                      <span>Bhubaneswar</span><span>Kolkata</span><span>Siliguri</span>
                    </div>
                  ...
                  <div className="mt-5 flex items-start gap-3 rounded-xl bg-primary/5 p-4 text-sm text-foreground">
                    ...
                    <span>Positioned at the heart of Eastern India's freight, port and highway corridors — West Bengal, Odisha, Bihar and the North-East within reach.</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-5">
              <SectionHeader
                eyebrow="Why Kolkata"
                title={<>Kolkata Works Better When Your Supply Chain <span className="text-primary">Needs Reach</span></>}
                description="Kolkata gives your business reach and connectivity, but without structured warehousing services in Kolkata, that advantage cannot convert into reliable and scalable operations."
              />
            </div>
            <div className="lg:col-span-7">
      ...
      <section className="relative overflow-hidden bg-secondary/40 py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            title={<>How Kolkata's Transport Network Moves Your Inventory <span className="text-primary">Faster Across Eastern India</span></>}
            description="Kolkata sits at the center of Eastern India's most important freight, highway and port-connected corridors — making it a strategic distribution hub for East and North-East India."
            align="center"
            className="mx-auto"
          />
        ...
        <div className="container relative mx-auto px-6">
          <div className="max-w-3xl">
            <SectionHeader
              ...
              title={<>Kolkata's Industrial Ecosystem and <span className="text-primary">What It Means for Your Inventory</span></>}
              description="Dankuni, Howrah and Uluberia are densely connected with transporters, courier hubs, packaging vendors and freight operators — creating an environment optimised for high-volume inventory movement, faster inbound freight and shorter carrier pickup windows."
            />
          </div>
            ...
            <div className="rounded-3xl border border-border bg-card p-7 shadow-card">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="font-display text-lg font-semibold text-ink">Kolkata Clusters We Operate Near</h3>
                </div>
              </div>
      ...
      <section id="facility" className="bg-secondary/40 py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            title={<>A Warehouse Facility in Kolkata That Supports <span className="text-primary">Faster Movement Across Eastern India</span></>}
            align="center"
            className="mx-auto"
          />
            ...
            <div className="grid lg:grid-cols-12">
              <div className="lg:col-span-5">
                <div className="aspect-[4/3] w-full bg-secondary lg:h-full">
                  <iframe
                    title="AAJ Supply Chain Management – Kolkata"
                    src="https://www.google.com/maps?q=AAJ+Supply+Chain+Management+Milki+Badamtola+Serampore+Hooghly+Kolkata+712223&output=embed"
              ...
              <div className="p-7 md:p-10 lg:col-span-7">
                <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                  <Building2 className="h-3.5 w-3.5" /> Kolkata, West Bengal
                </div>
                <h3 className="mt-4 font-display text-2xl font-semibold text-ink">AAJ Supply Chain Management – Kolkata Warehouse</h3>
                <p className="mt-3 flex gap-2 text-sm text-muted-foreground">
                  <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                  <span>Dag nos: 18, 19, 20 &amp; 68, Milki Badamtola, Serampore, Dist. Hooghly, Kolkata, West Bengal 712223</span>
                </p>
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <Button asChild variant="outline" size="sm">
                    <a href="https://maps.app.goo.gl/pBcvU9dFf2R1mBve7" target="_blank" rel="noreferrer">
      ...
      <section className="bg-background py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            title={<>Operations We Run at Our <span className="text-primary">Kolkata Warehouse</span></>}
            align="center"
            className="mx-auto"
          />
      ...
      <section className="bg-secondary/40 py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            title={<>Built for Brands Handling <span className="text-primary">Growing Demand Across Eastern India</span></>}
            description="If your operations involve Eastern India demand, faster delivery expectations or rising order volume, AAJ's warehousing company in Kolkata is built to support that scale."
            align="center"
            className="mx-auto"
          />
      ...
      {/* SECTION 9 - How AAJ runs Kolkata */}
      <section className="bg-secondary/40 py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            eyebrow="How AAJ runs Kolkata"
            title={<>Operational Practices That <span className="text-primary">Scale with Your Volume</span></>}
            description="These are the operational principles that keep our warehouse services in Kolkata reliable as your volume and SKU count grow."
            align="center"
            className="mx-auto"
          />
      ...
      <section className="bg-background py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            title={<>Move Operations to Our Kolkata Warehouse <span className="text-primary">Without Disrupting Orders</span></>}
            align="center"
            className="mx-auto"
          />
          <div className="relative mt-14">
      ...
      <section className="bg-secondary/40 py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            title={<>Hear from Brands Shipping Out of <span className="text-primary">Our Kolkata Hub</span></>}
            align="center"
            className="mx-auto"
          />
          <div className="mt-12 rounded-2xl border border-dashed border-border bg-card p-10 text-center text-sm text-muted-foreground">
            ...
            <p className="mt-3">Client testimonials from brands shipping out of Kolkata will appear here soon.</p>
          </div>
        </div>
      </section>
      )}
      ...
      <NetworkPresenceSection currentSlug="kolkata" />
      ...
      <section className="bg-background py-11 md:py-14">
        <div className="container mx-auto px-6">
          <SectionHeader
            eyebrow="FAQs"
            title={<>Quick Answers About <span className="text-primary">Our Kolkata Warehousing</span></>}
            align="center"
            className="mx-auto"
          />
            ...
            <div className="relative grid gap-8 md:grid-cols-12 md:items-center">
              <div className="md:col-span-8">
                ...
                <p className="mt-3 max-w-2xl text-base text-muted-foreground">
                  We review inventory, dispatch, coordination and same-day fulfilment readiness — then show you what shifting to Kolkata could change.
                </p>
              </div>
...
/* =========== CLIENT LOGOS — free rotation across 12 logos =========== */
const ClientLogos = () => {
  const logos: { src: string; alt: string }[] = [
    ...
    { src: synergyLogo, alt: "Synergy Intact" },
    { src: visscoLogo, alt: "Vissco" },
    { src: zorayaLogo, alt: "Zoraya" },
    { src: fridoLogo, alt: "Frido" },
